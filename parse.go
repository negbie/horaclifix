...
func ParseRecSipTCP(msg []byte) *IPFIX {
	...
	i.Data.SIP.IntPort = uint8(msg[9])
	i.Data.SIP.IntVlan = binary.BigEndian.Uint16(msg[10:12])
	i.Data.SIP.DstIP = binary.BigEndian.Uint32(msg[12:16])
	i.Data.SIP.SrcIP = binary.BigEndian.Uint32(msg[16:20])
	i.Data.SIP.DstPort = binary.BigEndian.Uint16(msg[20:22])
	i.Data.SIP.SrcPort = binary.BigEndian.Uint16(msg[22:24])
