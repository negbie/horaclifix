...
func (i *IPFIX) mapLogQOS() *map[string]interface{} {
	mLogQOS := map[string]interface{}{
		...
		"_incrVal":            float64(i.Data.QOS.IncrVal) / 100,
		"_incMos":             float64(i.Data.QOS.IncMos) / 100,
		...
		"_outrVal":            float64(i.Data.QOS.OutrVal) / 100,
		"_outMos":             float64(i.Data.QOS.OutMos) / 100,
...
func (i *IPFIX) mapMetricQOS() map[string]interface{} {
	mMetricQOS := map[string]interface{}{
		...
		"out.rtp.rval":         float64(i.Data.QOS.OutrVal) / 100,
		"inc.rtp.packets":      float64(i.Data.QOS.IncRtpPackets),
		"out.rtp.packets":      float64(i.Data.QOS.OutRtpPackets),
		"inc.rtcp.packets":     float64(i.Data.QOS.IncRtcpPackets),
		"out.rtcp.packets":     float64(i.Data.QOS.OutRtcpPackets),
		"inc.rtp.lostPackets":  float64(i.Data.QOS.IncRtpLostPackets),
		"out.rtp.lostPackets":  float64(i.Data.QOS.OutRtpLostPackets),
		"inc.rtcp.lostPackets": float64(i.Data.QOS.IncRtcpLostPackets),
		"out.rtcp.lostPackets": float64(i.Data.QOS.OutRtcpLostPackets),
		"inc.rtp.avgJitter":    float64(i.Data.QOS.IncRtpAvgJitter),
		"out.rtp.avgJitter":    float64(i.Data.QOS.OutRtpAvgJitter),
		"inc.rtp.maxJitter":    float64(i.Data.QOS.IncRtpMaxJitter),
		"out.rtp.maxJitter":    float64(i.Data.QOS.OutRtpMaxJitter),
		"inc.rtcp.avgJitter":   float64(i.Data.QOS.IncRtcpAvgJitter),
		"out.rtcp.avgJitter":   float64(i.Data.QOS.OutRtcpAvgJitter),
		"inc.rtcp.maxJitter":   float64(i.Data.QOS.IncRtcpMaxJitter),
		"out.rtcp.maxJitter":   float64(i.Data.QOS.OutRtcpMaxJitter),
		"inc.rtcp.avgLat":      float64(i.Data.QOS.IncRtcpAvgLat),
		"out.rtcp.avgLat":      float64(i.Data.QOS.OutRtcpAvgLat),
