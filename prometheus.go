...
func (conn *Connections) SendMetric(i *IPFIX, s string) {
	prom.GaugeMetrics[*name+"_inc_rtp_mos"].Set(float64(i.QOS.IncMos / 100))
	prom.GaugeMetrics[*name+"_out_rtp_mos"].Set(float64(i.QOS.OutMos / 100))
	prom.GaugeMetrics[*name+"_inc_rtp_rval"].Set(float64(i.QOS.IncrVal / 100))
	prom.GaugeMetrics[*name+"_out_rtp_rval"].Set(float64(i.QOS.OutrVal / 100))
	prom.GaugeMetrics[*name+"_inc_rtp_packets"].Set(float64(i.QOS.IncRtpPackets))
	prom.GaugeMetrics[*name+"_out_rtp_packets"].Set(float64(i.QOS.OutRtpPackets))
	prom.GaugeMetrics[*name+"_inc_rtcp_packets"].Set(float64(i.QOS.IncRtcpPackets))
	prom.GaugeMetrics[*name+"_out_rtcp_packets"].Set(float64(i.QOS.OutRtcpPackets))
	prom.GaugeMetrics[*name+"_inc_rtp_lostPackets"].Set(float64(i.QOS.IncRtpLostPackets))
	prom.GaugeMetrics[*name+"_out_rtp_lostPackets"].Set(float64(i.QOS.OutRtpLostPackets))
	prom.GaugeMetrics[*name+"_inc_rtcp_lostPackets"].Set(float64(i.QOS.IncRtcpLostPackets))
	prom.GaugeMetrics[*name+"_out_rtcp_lostPackets"].Set(float64(i.QOS.OutRtcpLostPackets))
	prom.GaugeMetrics[*name+"_inc_rtp_avgJitter"].Set(float64(i.QOS.IncRtpAvgJitter))
	prom.GaugeMetrics[*name+"_out_rtp_avgJitter"].Set(float64(i.QOS.OutRtpAvgJitter))
	prom.GaugeMetrics[*name+"_inc_rtp_maxJitter"].Set(float64(i.QOS.IncRtpMaxJitter))
	prom.GaugeMetrics[*name+"_out_rtp_maxJitter"].Set(float64(i.QOS.OutRtpMaxJitter))
	prom.GaugeMetrics[*name+"_inc_rtcp_avgJitter"].Set(float64(i.QOS.IncRtcpAvgJitter))
	prom.GaugeMetrics[*name+"_out_rtcp_avgJitter"].Set(float64(i.QOS.OutRtcpAvgJitter))
	prom.GaugeMetrics[*name+"_inc_rtcp_maxJitter"].Set(float64(i.QOS.IncRtcpMaxJitter))
	prom.GaugeMetrics[*name+"_out_rtcp_maxJitter"].Set(float64(i.QOS.OutRtcpMaxJitter))
	prom.GaugeMetrics[*name+"_inc_rtcp_avgLat"].Set(float64(i.QOS.IncRtcpAvgLat))
	prom.GaugeMetrics[*name+"_out_rtcp_avgLat"].Set(float64(i.QOS.OutRtcpAvgLat))
	prom.GaugeMetrics[*name+"_inc_rtcp_maxLat"].Set(float64(i.QOS.IncRtcpMaxLat))
	prom.GaugeMetrics[*name+"_out_rtcp_maxLat"].Set(float64(i.QOS.OutRtcpMaxLat))
	if i.QOS.EndTimeSec != 0 && i.QOS.BeginTimeSec != 0 {
		prom.GaugeMetrics[*name+"_duration"].Set(float64(i.QOS.EndTimeSec - i.QOS.BeginTimeSec))
	}
}
